        ...
        <section className="relative w-full bg-white dark:bg-slate-900 transition-colors duration-300 overflow-hidden">
            <div className="container mx-auto px-6 py-12 md:py-24 flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 z-10 text-center md:text-left">
                    <span className="inline-block px-4 py-1.5 mb-6 text-sm font-semibold tracking-wider text-green-700 uppercase bg-green-100 rounded-full dark:bg-green-900/30 dark:text-green-400">
                ...
                <div className="md:w-1/2 mt-12 md:mt-0 relative flex justify-center">
                    ...
                    <img className="spin absolute top-1/4 left-1/8" src="/Globe icon.svg" alt="" /></div>
                    ...
                    <div className="relative">
                        ...
                        {/* Floating Badge */}
                        <div className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 hidden sm:block">
